...
- Test projects: executable xUnit v3 projects with centralized versions and
  injected references/global usings for xUnit v3, the Visual Studio runner,
  FluentAssertions 7.2.0, NSubstitute, coverlet, and Atya.Governance.Testing
